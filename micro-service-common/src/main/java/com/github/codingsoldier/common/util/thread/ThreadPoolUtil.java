...
// * @since 2022-02-09
// */
//@Deprecated(since="已废弃，请使用com.github.codingsoldier.starter.web.config.ObservationTaskExecutionConfiguration.microServiceExecutor")
//@Slf4j
...
//
//  /**
//   * IO密集型应用的最大线程数 公式： CPU核心数 * (1 + 线程平均等待时间 / 线程平均工作时间)
//   * <p>
//   * 阻塞系数 = 阻塞时间 /（阻塞时间+计算时间） core / （1-阻塞系数） 和 core * ( 1 + w/c ) 这俩是同一公式
//   */
