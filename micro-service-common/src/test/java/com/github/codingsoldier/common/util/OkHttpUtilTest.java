...
class OkHttpUtilTest {
  ...
  @Test
  void getByte() {
    byte[] imageByte = OkHttpUtil.download(
  ...
  @Test
  void getString() {
    String url = "http://localhost:10001/boot-web/basic/params/path/111?msg=账号不ddddddddd够长";
  ...
  void get() {
    ...
    result = OkHttpUtil.get(
        "http://localhost:10001/boot-web/basic/params/path/111?msg=账号不够长&name=名字",
  ...
  @Test
  void testGet() {
    String url = "http://localhost:10001/boot-web/basic/params/path/111";
    HashMap<String, Object> params = new HashMap<>();
  ...
  @Test
  void testGet1() {
    String url = "http://localhost:10001/boot-web/basic/params/path/111?msg=账号禅城南村村长&name=名字";
    HashMap<String, String> headers = new HashMap<>();
    headers.put("xxxxxx", "aaaaaa");
  ...
  @Test
  void postString() {
    String url = "http://localhost:10001/boot-web/basic/time/bar";
  ...
  void testPost() {
    ...
    Result r1 = OkHttpUtil.post(url, ObjectMapperUtil.writeValueAsString(bodyMap), null,
        Result.class);
    ...
    Result<Map<String, Object>> r44 = OkHttpUtil.post(url,
        ObjectMapperUtil.writeValueAsString(bodyMap), headers, new TypeReference<>() {
        });
  ...
  void testPost1() {
    ...
    Result<Map<String, Object>> r44 = OkHttpUtil.post(url,
        ObjectMapperUtil.writeValueAsString(bodyMap), new TypeReference<>() {
        });
    assertEquals(ResultCodeEnum.SUCCESS.getCode(), r44.getCode());
    assertEquals("2023-01-01 01:01:01", r44.getData().get("localDateTime"));
  }
