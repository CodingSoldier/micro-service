...
class ObjectMapperUtilTest {
  ...
  void testReadValue() {
    ...
    String testStr = ObjectMapperUtil.readValue("测试字符串".getBytes(StandardCharsets.UTF_8),
        String.class);
    assertEquals("测试字符串", testStr);
  ...
  void testReadValue1() {
    ...
    map.put("name", "名字");
    String mapStr = "{\"id\":111,\"age\":232,\"name\":\"名字\"}";
    Map<String, Object> readMap = ObjectMapperUtil.readValue(mapStr,
  ...
  void testReadWrite() {
    ...
    OffsetDateTime offsetDateTime = OffsetDateTime.of(localDate, LocalTime.of(01, 01, 02),
        ZoneOffset.of("+8"));
