...
public class RouteEventServiceImpl implements ApplicationEventPublisherAware {
    /**
     * 写路由定义
     */
    ...
    public RouteEventServiceImpl(RouteDefinitionWriter routeDefinitionWriter,
    ...
    private String deleteById(String id) {
        ...
        try {
            ...
            log.error("gateway delete route fail。", ex);
            return "delete fail";
        }
    }
    ...
    private String updateByRouteDefinition(RouteDefinition definition) {
        ...
        try {
            ...
            log.error("gateway update delete route fail。", ex);
        ...
        try {
            ...
            log.error("gateway update save route fail。", ex);
