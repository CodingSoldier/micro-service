...
public class BasicController {
  ...
  public String timeout(@RequestParam("time") Long time) throws InterruptedException {
  ...
  public Result<Page<UserPageVO>> modelAttribute(@ModelAttribute @ParameterObject UserDTO dto) {
    dto.setName("junit测试修改名字");
    UserPageVO vo = new UserPageVO();
    BeanUtils.copyProperties(dto, vo);
    Page<UserPageVO> pageData = new Page<>(1L, 10L);
    pageData.setRecords(List.of(vo));
