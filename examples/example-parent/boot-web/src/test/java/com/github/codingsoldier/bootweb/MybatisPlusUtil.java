...
public class MybatisPlusUtil {
    ...
    public static String tableJavaName(String tableName) {
        String notPrefixTableName = delPrefix(tableName, MybatisPlusGenerator.TABLE_PREFIX);
    ...
    public static void main(String[] args) {
        ...
        if (tableName.startsWith(MybatisPlusGenerator.TABLE_PREFIX)){
            tableName = StringUtils.replaceOnce(tableName, MybatisPlusGenerator.TABLE_PREFIX, "");
        }
