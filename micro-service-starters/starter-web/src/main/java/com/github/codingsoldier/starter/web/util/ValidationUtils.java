...
public class ValidationUtils {
   ...
   *                         Default)
   */
  public static void validateEntity(Object object, final List<String> excludeFieldList,
      Class<?>... groups) {
    Set<ConstraintViolation<Object>> constraintViolations = validator.validate(object, groups);
    if (!constraintViolations.isEmpty()) {
      StringBuilder sb = new StringBuilder();
      ...
      //有message抛出异常
      if (!sb.isEmpty()) {
        throw new HttpStatus4xxException(ResultCodeEnum.PRECONDITION_FAILED.getCode(),
            sb.toString());
      }
    }
  }
