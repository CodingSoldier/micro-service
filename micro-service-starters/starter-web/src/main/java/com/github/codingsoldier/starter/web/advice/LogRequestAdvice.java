...
public class LogRequestAdvice extends CommonsRequestLoggingFilter implements RequestBodyAdvice {
  ...
  protected void afterRequest(HttpServletRequest request, String message) {
    if (!this.logPrinted) {
      log.info("在请求完成后打印，requestUri = {}，requestBody为空，queryString解码 = {}，method = {}",
          this.requestUri, decodeQueryString, this.methodName);
  ...
  public Object afterBodyRead(Object body,
    ...
    log.info("打印请求，requestUri = {}，requestBody = {}，queryString解码={}，method = {}",
        this.requestUri, requestBody, decodeQueryString, this.methodName);
    this.logPrinted = true;
    return body;
  }
